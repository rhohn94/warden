...
emits a structured JSON overview. Design: the status-broker-design.md and
mcp-server-design.md framework specs — they live only in the upstream
Grimoire repository, not in this project's own docs/.
