...
Backs the `grm-component-registry` skill (build/update `.claude/component-registry.json`)
and the `grm-component-catalog-export` skill (which renders a flat catalog view over
