...
Design authority: `docs/grimoire/design/issue-tracker-design.md` §8 (Reporter role
...
**escalates to the Researcher role** (`grm-researcher` skill — the on-demand
research-then-file path), which investigates in its own isolated session and
files one scoped item. See the canonical registry `docs/grimoire/design/agent-roles-design.md`.
...
demand. Full taxonomy doc: `docs/grimoire/integration-workflow.md` (RP2's domain).
...
Canonical role registry: `docs/grimoire/design/agent-roles-design.md`.
