...
```
python3 .claude/skills/grm-qa-agent/qa_select.py              # earliest unverified release
python3 .claude/skills/grm-qa-agent/qa_select.py --all        # every unverified release, oldest-first
python3 .claude/skills/grm-qa-agent/qa_select.py --window 3   # the last 3 releases
python3 .claude/skills/grm-qa-agent/qa_select.py --release v3.2
```
