---
name: grm-source-to-design-docs
description: Generate the docs/design/ file structure for an existing project by reading source code, READMEs, and any existing documentation. Produces populated design docs that follow the house layout. Use when onboarding an existing codebase into this workflow, or when design docs are missing for features that already exist.
---
...
Write this doc using the house layout (see **`grm-design-doc-scaffold`** skill).
