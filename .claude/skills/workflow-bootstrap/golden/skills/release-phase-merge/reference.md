...
`.claude/skills/sync-from-upstream/feature-manifest.md` (fields: `feature-id`,
...
- **Single item:** invoke `feedback-to-issue` directly (the abstraction routes
...
merge loop. See `docs/integration-workflow.md` §Filing issues with the Reporter
...
`docs/design/autonomy-hardening-design.md`):
