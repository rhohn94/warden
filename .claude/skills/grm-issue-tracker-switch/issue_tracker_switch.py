#!/usr/bin/env python3
"""issue-tracker-switch helper for the Grimoire grm-issue-tracker-switch skill.

Reads and writes the `grm-issue-tracker` block in `.claude/grimoire-config.json`.
